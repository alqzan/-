    ...
    <>
      ...
      {active ? (
        <Card className="text-center bg-gradient-to-b from-cream-50 to-peach-100">
          <ProgressRing value={active.count / TARGET} size={168} stroke={12}>
            <div className="text-center">
              <div className="text-5xl font-extrabold text-sage-800">{active.count}</div>
              <div className="text-sm text-sage-400">من {TARGET}</div>
            </div>
          </ProgressRing>
        ...
        <Card className="text-center">
          ...
          <p className="text-sm text-sage-400 mb-4">
            اجلسي مرتاحة وسجّلي كل حركة تشعرين بها. الهدف {TARGET} حركات.
          </p>
